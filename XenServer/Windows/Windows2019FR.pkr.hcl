...
source "xenserver-iso" "windows2019" {
  iso_checksum                 = "2749b98065550f8b22bdf92119af9f19a22f4c056807d9aa86f8cc554e85fd91a10b5710b2d52e3564f4e1e16da54c1239f1eb8df2f72a3b14d1b002e41f1602"
  iso_url                      = "http://10.35.10.130:8081/repository/ISOS/WindowsServer2019FR.iso"
  ...
  vm_name         = "Win2019FR_template"
  vm_description  = "VM for Windows Server 2019 FR"
  vcpus_max       = 4
  vcpus_atstartup = 4
  vm_memory       = 16384 # MB
  network_names   = ["MAD4-CORE-ADM-MGMT-VLAN60"]
  disk_size       = 81920 # MB
  disk_name       = "Win2019FR_template_disk"
  floppy_files = [
    "./floppy/fr19/autounattend.xml",
    "./floppy/fr19/cloudbase-init-unattend.conf",
    "./floppy/fr19/cloudbase-init.conf",
    "./floppy/fr19/Unattend.xml",
    "./floppy/fr19/winunattend.xml",
    "./scripts/Cleanup.ps1",
  ...
  output_directory       = "packer-Win2019FR"
  keep_vm                = "never"
  format                 = "vdi_vhd"
