...
source "xenserver-iso" "windows2016" {
  iso_checksum                 = "cad29127f59fbe1fd1facd43f25154813c37d638c31339a67dbfc81b6e70927cd426045f74aad007996aa086bf863fc33854d48363f2f45356cc450ae5cd2c46"
  iso_url                      = "http://10.35.10.130:8081/repository/ISOS/WindowsServer2016EN.iso"
  ...
  vm_name         = "Win2016EN_template"
  vm_description  = "VM for Windows Server 2016 EN"
  vcpus_max       = 4
  vcpus_atstartup = 4
  vm_memory       = 16384 # MB
  network_names   = ["MAD4-CORE-ADM-MGMT-VLAN60"]
  disk_size       = 81920 # MB
  disk_name       = "Win2016EN_template_disk"
  floppy_files = [
    "./floppy/en16/autounattend.xml",
    "./floppy/en16/cloudbase-init-unattend.conf",
    "./floppy/en16/cloudbase-init.conf",
    "./floppy/en16/Unattend.xml",
    "./floppy/en16/winunattend.xml",
    "./scripts/Cleanup.ps1",
  ...
  output_directory       = "packer-Win2016EN"
  keep_vm                = "never"
  format                 = "vdi_vhd"
