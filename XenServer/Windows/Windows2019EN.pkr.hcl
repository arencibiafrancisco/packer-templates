...
source "xenserver-iso" "windows2019" {
  iso_checksum                 = "2040748751ca27c63978f20b20c1974f727243b3def86bd2a24e871781c934b4694ac3ec0f04e3592677abc5e6727694d2858fa48e515d76f0f5e1face7fec36"
  iso_url                      = "http://10.35.10.130:8081/repository/ISOS/WindowsServer2019EN.iso"
  ...
  vm_name         = "Win2019EN_template"
  vm_description  = "VM for Windows Server 2019 EN"
  vcpus_max       = 4
  vcpus_atstartup = 4
  vm_memory       = 16384 # MB
  network_names   = ["MAD4-CORE-ADM-MGMT-VLAN60"]
  disk_size       = 81920 # MB
  disk_name       = "Win2019EN_template_disk"
  floppy_files = [
    "./floppy/en19/autounattend.xml",
    "./floppy/en19/cloudbase-init-unattend.conf",
    "./floppy/en19/cloudbase-init.conf",
    "./floppy/en19/Unattend.xml",
    "./floppy/en19/winunattend.xml",
    "./scripts/Cleanup.ps1",
  ...
  output_directory       = "packer-Win2019EN"
  keep_vm                = "never"
  format                 = "vdi_vhd"
